...
class FourTUMapper
{
    ...
    public function __construct()
    {
        ...
        $this->figshareHelper = new FigshareFilesHelper();
    }
    ...
    {        
        ...
        foreach ($files as $file) {
            $file = [
                'msl_file_name' => $this->extractFilename((string)$file['name']),
                'msl_download_link' => (string)$file['download_url'],
                'msl_extension' => $this->extractExtension((string)$file['name']),
                'msl_timestamp' => ''
            ];

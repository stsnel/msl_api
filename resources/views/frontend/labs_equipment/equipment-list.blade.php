<x-layout_main>
    <div class="flex justify-center items-center ">
        <div role="tablist" class="tabs tabs-lifted">
            ...
            <a role="tab" href="{{ route('equipment-list') }}" class="tab tab-active">Equipment list</a>
        </div>
    </div>
                ...
                <div class="grow w-full">
                    <div class="w-full flex flex-col bg-base-100">
                        ...
                        <div class='grow mx-auto p-4 w-full'>
                            <div class="relative flex items-center w-full h-12 rounded-lg focus-within:shadow-lg overflow-hidden">
                                ...
                                <form method="get" class="w-full h-16">
                                    ...
                                    <input class="peer h-full w-full outline-none text-sm pr-2" type="text" id="search" placeholder="Search equipment.." name="query" /> 
                                </form>
                            </div>
                        </div>
                        ...
                        <div class="grow flex justify-between p-4 px-10">
                            ...
                            <div>
                                <h5>{{ $result->getTotalResultsCount() }} equipment found</h5>
                            </div>
                        ...
                        <div class="flex flex-col ">
                            ...
                            <div class="border-t border-slate-200/50 hover:bg-secondary ">
                                <div class="p-4">                                    
                                       ...
                                       <span>{{ $equipment['msl_description'] }}</span>
                                </div>
                            </div>    
